                ...
                <div className="w-full flex flex-col lg:flex-row">
                    <div className="flex lg:flex-row px-3 py-0 w-full">
                        ...
                        <button data-collapse-toggle="header-navbar" type="button"
                            className="inline-flex items-center ml-auto mr-3 p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
