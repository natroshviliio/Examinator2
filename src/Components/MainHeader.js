...
const MainHeader = ({ darkMode, changeDarkMode }) => {
    ...
    const showBurgerMenu = () => setNavbarCollapse(!navbarCollapse);

    const [userCollapse, setUserCollapse] = useState(false);
    const showUserDropdown = () => setUserCollapse(!userCollapse);
            ...
            <div className="container mx-auto">
                <div className="w-full flex flex-col lg:flex-row">
                    <div className="flex lg:flex-row px-3 py-0 w-full">
                        ...
                        <button onClick={showBurgerMenu} data-collapse-toggle="header-navbar" type="button" className="inline-flex items-center ml-auto mr-3 p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="header-navbar" aria-expanded="false">
                        ...
                        <div className="lg:relative flex items-center ml-3">
                            ...
                            <div id="dropdownAvatar" className={`z-10 ${userCollapse ? '' : 'hidden'} absolute top-[80%] lg:top-[100%] left-0 lg:left-[50%] w-full lg:w-fit lg:translate-x-[-50%] bg-white divide-y divide-gray-100 rounded-lg shadow-md w-44 dark:bg-gray-700 dark:divide-gray-600`}>
