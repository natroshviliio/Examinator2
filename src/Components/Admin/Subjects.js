    ...
    return (
        <div className="p-3 flex flex-col h-full overflow-hidden">
            <div className="p-2 flex flex-col lg:flex-row flex-wrap gap-4 border border-teal-300 rounded-md alk-sanet lg:justify-center items-start content-start h-full overflow-y-auto overflow-v">
                <button className="w-full lg:w-auto group py-2 px-5 text-teal-600 dark:text-slate-300 border border-teal-300 bg-teal-300 hover:bg-teal-400 dark:border-slate-500 dark:bg-slate-500 dark:hover:bg-slate-600 rounded-lg transition-all duration-300 flex items-center">
                    <span className="flex items-center gap-3">თემატიკის დამატება <RiAddLargeFill /></span>
                </button>
                <button className="w-full lg:w-auto group py-2 px-5 text-teal-500 dark:text-slate-300 border border-teal-300 hover:bg-teal-300 hover:text-white dark:border-slate-500 dark:hover:bg-slate-500 rounded-lg transition-all duration-300 flex items-center">
