                                        ...
                                        <div className="lg:w-6/12 flex flex-col gap-4">
                                            <div className="relative p-3 border border-teal-300 rounded">
                                                ...
                                                <div className="flex flex-col 2xl:flex-row 2xl:items-center gap-3">
                                                    <textarea className="border-teal-300 rounded-md w-8/12 focus:ring-teal-300 focus:border-teal-300 dark:border-slate-300 dark:focus:ring-slate-300 min-h-10 max-h-[5rem] overflow-y-auto overflow-v bg-white text-gray-600 dark:bg-slate-500 dark:text-gray-200 dark:placeholder:text-gray-200" placeholder="პასუხი..."></textarea>
