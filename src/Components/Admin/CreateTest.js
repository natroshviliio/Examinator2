        ...
        <div className="p-3 flex flex-col flex-1">
            ...
            <div className="p-2 mt-3 border border-gray-300 dark:border-slate-400 rounded-md w-full flex flex-1">
                <div className="grid w-full max-w-full">
                    <Swiper slidesPerView={1} pagination={{ dinamycBullets: true }} modules={[Pagination]} className="swiper bg-gray-100 dark:bg-slate-600/[.3] rounded-lg flex flex-1 h-full">
                        <SwiperSlide className="">
                            <div className="p-2">
                                ...
                                <div className="p-2 w-full">
                                    <div className="w-full mt-3 flex flex-col lg:flex-row gap-5 flex-1">
